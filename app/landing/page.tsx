...
const demoMonthlyTrends: MonthlyTrendPoint[] = [
...
const demoProviderStats: ProviderStatPoint[] = [
    ...
    <div className="space-y-16 animate-fade-in py-6">
      ...
      <section className="text-center space-y-6 max-w-3xl mx-auto pt-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-900/5 dark:bg-neutral-100/10 border border-neutral-200 dark:border-neutral-800 text-xs font-bold text-neutral-800 dark:text-neutral-200 uppercase tracking-wider">
          ...
          <span>EV Ownership Analytics</span>
        </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <MonthlyTrendChart data={demoMonthlyTrends} currencySymbol="$" />
        </div>
        <div className="lg:col-span-1">
          <ProviderBreakdownChart data={demoProviderStats} />
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-left">
            <h3 className="text-2xl font-extrabold text-neutral-900 dark:text-white font-outfit">
              Everything you need for complete personal EV ownership.
            </h3>
            <ul className="text-xs text-neutral-600 dark:text-neutral-300 space-y-2 font-medium">
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                <span>Multi-currency support with custom gasoline benchmark comparisons</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                <span>Bulk Excel & CSV import engine for historical charging spreadsheets</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                <span>Private & local-first architecture with Turso cloud database sync</span>
              </li>
            </ul>
          </div>
